...
#DB_Location="sqlite:///../db/chinook.db"
DB_Location="sqlite:///C:/AIContent/GhostAI/db/chinook.db"

llama_local='../TheBloke/Llama-2-7B-Chat-GGML/llama-2-7b-chat.ggmlv3.q8_0.bin'
...
with col1:
    st.image(logo2, width=200)  # Column 1, Row 1


# Add content to the third column
with col2:
    st.image(logo, width=200)  # Column 3, Row 1


# Define tabs for different functionalities
gemini_pro, groc_interaction, local_llama, gemini_vision, db_interaction, pdf_interaction, video_summary = st.tabs(
    ["Gemini",  "Groq",  "llama local", "Interact with Images", "Data Steward's Query Hub", "Pdf Interaction", "Video Summary"])
...
def main():
    with gemini_pro:
        ...
        prompt = st.text_input("Prompt Please:", "Give me name of all states in USA")
        model = genai.GenerativeModel("gemini-1.5-pro")
    ...
    with gemini_vision:
        ...
        st.header("Interact with Pictures")
        st.write("")
    ...
    with local_llama:
        ...
        st.header("Interact with Local LLAMA")
        st.write("")

        input_text = st.text_input("Prompt Please: ","Give me name of all states in USA")
    ...
    with pdf_interaction:
        ...
        st.header("Interaction with Documents")
    ...
    with groc_interaction:
        ...
        st.header("Interact with Groq")
        user_input_detail = st.text_input("Enter your message:","Give me name of all states in USA")
    ...
    with video_summary:
        st.header("Interact with Video's")
        st.write("")
